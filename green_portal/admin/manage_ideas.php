                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                                                <?php if ($is_pending): ?>
                                                    <button onclick="openApproveModal(<?php echo $row['id']; ?>)" class="btn btn-sm btn-approve" style="background-color: var(--status-approved-text); color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer;">Approve</button>
